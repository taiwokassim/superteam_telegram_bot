...
export type ParentSkills = keyof typeof skillSubSkillMap;
export type SubSkillsType = (typeof skillSubSkillMap)[ParentSkills][number]['value'];

export const allSubSkills = Object.values(skillSubSkillMap).flatMap((skills) =>
  skills.map((s) => s.value),
);

export const allParentSkills = Object.keys(skillSubSkillMap) as ParentSkills[];
